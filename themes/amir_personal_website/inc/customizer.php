 ...
 */
function amirpersonal_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'theme_bg_color', 
				array(
					'label'		=> __( 'Header and footer background color', 'amirpersonal'),
					'section'	=> 'colors',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'interactive_color', array(
				'label'		=> __( 'Interactive color (links etc)', 'amirpersonal' ),
				'section'	=> 'colors',
	...
	$wp_customize->add_section( 'theme_options', 
		array(
			'title'			=> __( 'Theme Options', 'amirpersonal' ),
			'priority'		=> 95,
			'capability'	=> 'edit_theme_options',
			'description'	=> __( 'Change how much of a post is displayed on index and archive pages.', 'amirpersonal' )
		)
	);
	...
	$wp_customize->add_setting(	'length_setting',
		array(
			'default'			=> 'excerpt',
			'type'				=> 'theme_mod',
			'sanitize_callback' => 'amirpersonal_sanitize_length', // Sanitization function appears further down
			'transport'			=> 'postMessage'
		)
	);

	// Add the controls
	$wp_customize->add_control(	'amirpersonal_length_control',
		array(
			'type'		=> 'radio',
			'label'		=> __( 'Index/archive displays', 'amirpersonal' ),
			'section'	=> 'theme_options',
			'choices'	=> array(
				'excerpt'		=> __( 'Excerpt (default)', 'amirpersonal' ),
				'full-content'	=> __( 'Full content', 'amirpersonal' )
			),
...
add_action( 'customize_register', 'amirpersonal_customize_register' );

/**
 * Binds JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function amirpersonal_customize_preview_js() {
	wp_enqueue_script( 'amirpersonal_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'amirpersonal_customize_preview_js' );
...
function amirpersonal_sanitize_length( $value ) {
...
if ( ! function_exists( 'amirpersonal_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see amirpersonal_custom_header_setup().
 */
function amirpersonal_header_style() {
