 ...
 */
function amirpersonal_content_image_sizes_attr( $sizes, $size ) {
	$width = $size[0];
...
add_filter( 'wp_calculate_image_sizes', 'amirpersonal_content_image_sizes_attr', 10, 2 );
 ...
 */
function amirpersonal_header_image_tag( $html, $header, $attr ) {
	if ( isset( $attr['sizes'] ) ) {
		$html = str_replace( $attr['sizes'], '100vw', $html );
	}
	return $html;
}
add_filter( 'get_header_image_tag', 'amirpersonal_header_image_tag', 10, 3 );
 ...
 */
function amirpersonal_post_thumbnail_sizes_attr( $attr, $attachment, $size ) {
...
add_filter( 'wp_get_attachment_image_attributes', 'amirpersonal_post_thumbnail_sizes_attr', 10, 3 );
...
function amirpersonal_widgets_init() {
	register_sidebar( array(
		...
		register_sidebar( array(
		'name'          => esc_html__( 'page sidebar', 'amirpersonal' ),
		'id'            => 'sidebar-2',
		'description'   => esc_html__( 'Add widgets here.', 'amirpersonal' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Widgets', 'amirpersonal' ),
		'id'            => 'footer-1',
		'description'   => esc_html__( 'Add footer widgets here.', 'amirpersonal' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
